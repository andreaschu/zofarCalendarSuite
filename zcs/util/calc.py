...
from zcs.data.xmlutil import read_questionnaire, VarRef, JsonAttrRef, Variable, JsonAttr, Questionnaire
from typing import Dict, Union, Tuple
from collections import defaultdict
from zcs.caljson.util import create_module
from zcs.data.util import compress_and_hexencode
from zcs.util.util import timestamp
import math
...
def calculate(xml_source: Union[Path, str]) -> None:
    """
    creates a graph with size estimations of a json string with the given qml modules and counts,
     compressed and uncompressed
    :param xml_source: input xml file
    :return:
    """
